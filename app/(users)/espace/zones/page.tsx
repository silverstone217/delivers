...
import AddZone from "@/components/services/tarif/AddZone";
import { GroupZoneCard } from "@/components/services/tarif/ZoneCard";
...
async function page() {
  ...
  const zones = await getZones(company.id); // Assumes include communes
